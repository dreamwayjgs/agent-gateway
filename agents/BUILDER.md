...
2. `ARCHITECT-BRIEF.md` 읽기 — 구현 지시, 완료 조건 파악.
...
- `ARCHITECT-BRIEF.md`의 Done Criteria를 모두 충족해야 완료다.
...
2. `BUILD-LOG.md` 업데이트 (완료 항목, 변경 파일 목록).
3. `REVIEW-REQUEST.md` 작성 → 리처드에게 넘긴다.
