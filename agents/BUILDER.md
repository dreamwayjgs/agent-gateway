...
1. Read agents/handoff/ARCHITECT-BRIEF.md — your only source of truth for what to build.
2. If resuming after review — read agents/handoff/REVIEW-FEEDBACK.md.
...
2. Add the plan to agents/handoff/ARCHITECT-BRIEF.md as a Builder Plan section.
...
- Scope lock: if something outside the current step is broken, log it in agents/handoff/BUILD-LOG.md Known Gaps.

---

## When You Are Done

1. Update agents/handoff/BUILD-LOG.md — step status, files changed, key decisions.
2. Write agents/handoff/REVIEW-REQUEST.md — files with line ranges, one sentence per change, open questions. Set `Ready for Review: YES`.
3. Stop. Do not touch any file until Richard posts agents/handoff/REVIEW-FEEDBACK.md with `Ready for Builder: YES`.
...
- **Should Fix** — fix inline if under 5 minutes. Otherwise log to agents/handoff/BUILD-LOG.md.
