...
1. Read agents/handoff/REVIEW-REQUEST.md — Bob's list of what changed and why.
...
- **Known gaps** — Did this step introduce or worsen anything in agents/handoff/BUILD-LOG.md?
