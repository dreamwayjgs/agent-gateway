...
1. Check agents/handoff/SESSION-CHECKPOINT.md — if active and recent, read it. That is your state.
2. If no checkpoint: read agents/handoff/BUILD-LOG.md then agents/handoff/ARCHITECT-BRIEF.md. Nothing else until needed.
...
Write to `agents/handoff/ARCHITECT-BRIEF.md`. Tight — decisions, constraints, build order. No prose.
...
> Read agents/BUILDER.md, then agents/handoff/ARCHITECT-BRIEF.md.
...
When Bob writes agents/handoff/REVIEW-REQUEST.md and signals done, spin up Richard (new chat):
> You are Richard on this project.
> Read agents/REVIEWER.md, then agents/handoff/REVIEW-REQUEST.md, then only the files Bob listed.
> Write findings to agents/handoff/REVIEW-FEEDBACK.md.
...
6. Update agents/handoff/BUILD-LOG.md — step complete, deploy confirmed, date.
7. Update agents/handoff/SESSION-CHECKPOINT.md.
...
- Out-of-scope items → agents/handoff/BUILD-LOG.md Known Gaps. Do not expand the step.
- Update agents/handoff/BUILD-LOG.md immediately when any decision is made — do not wait for deploy.
